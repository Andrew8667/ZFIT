 ...
 */
const FinishingWorkoutDetails = function FinishingWorkoutDetails({
  setFinishingModalVisible,
  source,
  navigation,
  workoutId,
  type
  ...
  const checkAlert = function checkAlert() {
    //returns an alert if title is empty
    return Alert.alert("Missing Title", "Please give your workout a title");
  };
  return (
      ...
      <View style={styles.modalContainer}>
        <ScrollView style={styles.infoContainer}>
          <View style={styles.titleContainer}>
            <CustomText
              text="Title: "
              textStyle={{ color: "#000000", fontSize: 20, fontWeight: 600 }}
            ></CustomText>
            <TextInput
        ...
        <View style={styles.btnContainer}>
          ...
          ></CustomButton>
          <CustomButton
            text={source === "finish" ? "Submit" : "Save"}
            extraBtnDesign={{
